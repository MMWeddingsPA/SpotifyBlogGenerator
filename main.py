...
def init_session_state():
    ...
    defaults = {
        ...
        'title_style': 'Fun & Creative',
        'intro_theme': 'Welcome & Overview',
        'conclusion_theme': 'Summary & Celebration',
        'section_count': 4,
        'active_tab': 0,
        'wp_search_term': '',
        'wp_posts': [],
        'wp_selected_post': None,
        'wp_post_confirmed': False,
        'wp_revamped_content': None,
        'wp_categories': [],
        'wp_selected_post_id': None,
        'wp_revamp_model': 'gpt-4o',
        'wp_revamp_temp': 0.8,
        'wp_revamp_tone': 'Friendly',
        'wp_revamp_mood': 'Excited',
        'wp_revamp_audience': 'General',
        'wp_revamp_guidance': '',
        'wp_edit_model': 'gpt-4o',
        'wp_edit_temp': 0.8,
        'wp_edit_tone': 'Friendly',
        'wp_edit_mood': 'Excited',
        'wp_edit_audience': 'General',
        'wp_edit_guidance': '',
        'wp_edit_revamped_content': None
    }
